...
namespace CPTS321
{
    ...
    {
        /// <summary>
        /// cell which is used by current tree.
        /// </summary>
        public SCell Treecell;
        ...
        /// </summary>
        private Dictionary<string, double> cellVariables = new Dictionary<string, double>();
        ...
        /// <summary>
        /// Gets variables Dictonary.
        /// </summary>
        public Dictionary<string, double> Cellvariables
        {
            get
            {
        ...
        {
            this.cellVariables[variableName] = variableValue;
        }
        ...
        private ExpressionTreeNode BuildTree(string infixstring)
        {
            ...
            if (infixstring.Length != 0)
            {
                ...
                foreach (var symbol in poststring)
                {
                    ...
                    {
                        this.cellVariables[symbol] = 0.0;
                        expressionTreeStack.Push(new VariableNode(ref this.cellVariables, symbol));
                    }
                }
